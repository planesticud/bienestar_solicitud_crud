...
// @Param	body		body 	models.SubtipoServicio	true		"body for SubtipoServicio content"
// @Success 201 {int} models.SubtipoServicio
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *SubtipoServicioController) Post() {
	var v models.SubtipoServicio
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddSubtipoServicio(&v); err == nil {
...
// @Success 200 {object} models.SubtipoServicio
// @Failure 404 not found resource
// @router /:id [get]
func (c *SubtipoServicioController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetSubtipoServicioById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
...
func (c *SubtipoServicioController) GetAll() {
	...
	l, err := models.GetAllSubtipoServicio(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
...
func (c *SubtipoServicioController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.SubtipoServicio{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateSubtipoServicioById(&v); err == nil {
			c.Data["json"] = "OK"
...
func (c *SubtipoServicioController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteSubtipoServicio(id); err == nil {
