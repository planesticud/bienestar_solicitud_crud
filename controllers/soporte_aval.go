...
// @Param	body		body 	models.SoporteAval	true		"body for SoporteAval content"
// @Success 201 {int} models.SoporteAval
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *SoporteAvalController) Post() {
	var v models.SoporteAval
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddSoporteAval(&v); err == nil {
...
// @Success 200 {object} models.SoporteAval
// @Failure 404 not found resource
// @router /:id [get]
func (c *SoporteAvalController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetSoporteAvalById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
...
func (c *SoporteAvalController) GetAll() {
	...
	l, err := models.GetAllSoporteAval(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
...
func (c *SoporteAvalController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.SoporteAval{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateSoporteAvalById(&v); err == nil {
			c.Data["json"] = "OK"
...
func (c *SoporteAvalController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteSoporteAval(id); err == nil {
