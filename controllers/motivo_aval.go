...
// @Param	body		body 	models.MotivoAval	true		"body for MotivoAval content"
// @Success 201 {int} models.MotivoAval
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *MotivoAvalController) Post() {
	var v models.MotivoAval
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddMotivoAval(&v); err == nil {
...
// @Success 200 {object} models.MotivoAval
// @Failure 404 not found resource
// @router /:id [get]
func (c *MotivoAvalController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetMotivoAvalById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
...
func (c *MotivoAvalController) GetAll() {
	...
	l, err := models.GetAllMotivoAval(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
...
func (c *MotivoAvalController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.MotivoAval{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateMotivoAvalById(&v); err == nil {
			c.Data["json"] = "OK"
...
func (c *MotivoAvalController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteMotivoAval(id); err == nil {
