...
// @Param	body		body 	models.TipoServicio	true		"body for TipoServicio content"
// @Success 201 {int} models.TipoServicio
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *TipoServicioController) Post() {
	var v models.TipoServicio
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoServicio(&v); err == nil {
...
// @Success 200 {object} models.TipoServicio
// @Failure 404 not found resource
// @router /:id [get]
func (c *TipoServicioController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoServicioById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
...
func (c *TipoServicioController) GetAll() {
	...
	l, err := models.GetAllTipoServicio(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
...
func (c *TipoServicioController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoServicio{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoServicioById(&v); err == nil {
			c.Data["json"] = "OK"
...
func (c *TipoServicioController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoServicio(id); err == nil {
