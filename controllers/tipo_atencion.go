...
// @Param	body		body 	models.TipoAtencion	true		"body for TipoAtencion content"
// @Success 201 {int} models.TipoAtencion
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *TipoAtencionController) Post() {
	var v models.TipoAtencion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoAtencion(&v); err == nil {
...
// @Success 200 {object} models.TipoAtencion
// @Failure 404 not found resource
// @router /:id [get]
func (c *TipoAtencionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoAtencionById(id)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
...
func (c *TipoAtencionController) GetAll() {
	...
	l, err := models.GetAllTipoAtencion(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
...
func (c *TipoAtencionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoAtencion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoAtencionById(&v); err == nil {
			c.Data["json"] = "OK"
...
func (c *TipoAtencionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoAtencion(id); err == nil {
